...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="header">Teller Authentication</div>
        <div class="image">
            <img src="../images/noted.svg" alt="">
        </div>

        <div class="fields">
            <input type="text" placeholder="Username" class="name-field">
            <input type="password" placeholder="Password" class="password-field">
            <button type="button" id="login-btn" onclick="login('Teller')">LOGIN</button>
        </div>
